...
import {PersonCircle, Trash, Search} from 'react-bootstrap-icons';
...
export default function ShowPost(props: any) {
    ...
    const renderlist = (data: any) => {
        return (data?.comments?.map((coment: any, Id: number) => (
            <MDBCard className="mb-4" key={Id}>
                <MDBCardBody>
                    ...
                    <div className="d-flex justify-content-between">
                        ...
                        <div className="d-flex flex-row align-items-center">
                            <p className="small text-muted mb-0"><ReactTimeAgo date={coment?.created} locale="pl-PL"/>
                            </p>
                            <MDBIcon
                                far
                            ...
                            />
                            <Trash onClick={() => deleteComment(coment?.id, coment?.user?.email)}
    ...
    return (
        <>
        <Search onClick={handleShow} style={{width: "25", height: "25"}}/>
